...
*/  
  ...
  c1->Update();
  c1->SaveAs("plots_Run2017C/Efficiency_"+TString(outFileName_)+"_sel.png");
  c1->SaveAs("plots_Run2017C/Efficiency_"+TString(outFileName_)+"_sel.pdf");
  c1->SaveAs("plots_Run2017C/Efficiency_"+TString(outFileName_)+"_sel.jpg");
}
...
void plotMetEfficiencyAll()
{
  ...
  legends_data_Type1.push_back("HLT Type-1 E_{T}^{miss} > 200 GeV, HBHE Cleaned");
  legends_data_Type1.push_back("HLT E_{T}^{miss} > 250 GeV, HBHE Cleaned");

  plotMetEfficiency(pathNames_PFMETTypeOne, filenames_data_2016G_Type1, legends_data_Type1, "HLT_PFMET_2017C", "");
